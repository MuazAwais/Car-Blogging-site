        ...
        {isOpen && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-[#232536] p-8 rounded-lg text-white relative">
                   ...
                   <h2 className="font-bold text-[45px]">Subscribe to site :</h2>
                   <form action="Subscribe" className="flex flex-col gap-3 mt-4">
                    <label htmlFor="email" className="text-[25px] font-bold ">Email:</label>
                    ...
                    <button type="submit" className="bg-[#ff5959] max-w-fit text-[20px] mx-auto text-[#ffffff] py-4 px-8 rounded hover:bg-[#f0f0f0] hover:text-[#232536]" onClick={handleToggle}>Subscribe</button>
                   </form>
                </div>
            </div>
        )}
